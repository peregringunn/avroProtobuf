...
public class nobelPrize extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private com.hitachivantara.models.avro.prizesRecord prizes;
   ...
   */
  public nobelPrize(com.hitachivantara.models.avro.prizesRecord prizes) {
    this.prizes = prizes;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: prizes = (com.hitachivantara.models.avro.prizesRecord)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.hitachivantara.models.avro.prizesRecord getPrizes() {
    return prizes;
  }
   ...
   */
  public void setPrizes(com.hitachivantara.models.avro.prizesRecord value) {
    this.prizes = value;
  }
   ...
   */
  public static com.hitachivantara.models.avro.nobelPrize.Builder newBuilder() {
    return new com.hitachivantara.models.avro.nobelPrize.Builder();
  }
   ...
   * @return A new nobelPrize RecordBuilder
   */
  public static com.hitachivantara.models.avro.nobelPrize.Builder newBuilder(com.hitachivantara.models.avro.nobelPrize.Builder other) {
    if (other == null) {
      return new com.hitachivantara.models.avro.nobelPrize.Builder();
    } else {
      return new com.hitachivantara.models.avro.nobelPrize.Builder(other);
    }
  }
   ...
   * @return A new nobelPrize RecordBuilder
   */
  public static com.hitachivantara.models.avro.nobelPrize.Builder newBuilder(com.hitachivantara.models.avro.nobelPrize other) {
    if (other == null) {
      return new com.hitachivantara.models.avro.nobelPrize.Builder();
    } else {
      return new com.hitachivantara.models.avro.nobelPrize.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<nobelPrize>
    ...
    private com.hitachivantara.models.avro.prizesRecord prizes;
    private com.hitachivantara.models.avro.prizesRecord.Builder prizesBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.hitachivantara.models.avro.nobelPrize.Builder other) {
      super(other);
      ...
      if (other.hasPrizesBuilder()) {
        this.prizesBuilder = com.hitachivantara.models.avro.prizesRecord.newBuilder(other.getPrizesBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.hitachivantara.models.avro.nobelPrize other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.prizes)) {
        this.prizes = data().deepCopy(fields()[0].schema(), other.prizes);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.models.avro.nobelPrize.Builder setPrizes(com.hitachivantara.models.avro.prizesRecord value) {
     ...
     * @return This builder.
     */
    public com.hitachivantara.models.avro.prizesRecord.Builder getPrizesBuilder() {
      if (prizesBuilder == null) {
        if (hasPrizes()) {
          setPrizesBuilder(com.hitachivantara.models.avro.prizesRecord.newBuilder(prizes));
        } else {
          setPrizesBuilder(com.hitachivantara.models.avro.prizesRecord.newBuilder());
        }
      }
    ...
    public com.hitachivantara.models.avro.nobelPrize.Builder setPrizesBuilder(com.hitachivantara.models.avro.prizesRecord.Builder value) {
      clearPrizes();
      prizesBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.models.avro.nobelPrize.Builder clearPrizes() {
      prizes = null;
      prizesBuilder = null;
    ...
    public nobelPrize build() {
      try {
        ...
        if (prizesBuilder != null) {
          ...
          record.prizes = fieldSetFlags()[0] ? this.prizes : (com.hitachivantara.models.avro.prizesRecord) defaultValue(fields()[0]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (this.prizes == null) {
        this.prizes = new com.hitachivantara.models.avro.prizesRecord();
      }
