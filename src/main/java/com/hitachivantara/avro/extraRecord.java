...
public class extraRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.hitachivantara.avro.extraRecord.Builder newBuilder() {
    return new com.hitachivantara.avro.extraRecord.Builder();
  }
   ...
   * @return A new extraRecord RecordBuilder
   */
  public static com.hitachivantara.avro.extraRecord.Builder newBuilder(com.hitachivantara.avro.extraRecord.Builder other) {
    if (other == null) {
      return new com.hitachivantara.avro.extraRecord.Builder();
    } else {
      return new com.hitachivantara.avro.extraRecord.Builder(other);
    }
  }
   ...
   * @return A new extraRecord RecordBuilder
   */
  public static com.hitachivantara.avro.extraRecord.Builder newBuilder(com.hitachivantara.avro.extraRecord other) {
    if (other == null) {
      return new com.hitachivantara.avro.extraRecord.Builder();
    } else {
      return new com.hitachivantara.avro.extraRecord.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<extraRecord>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.hitachivantara.avro.extraRecord.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.hitachivantara.avro.extraRecord other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.address)) {
        this.address = data().deepCopy(fields()[0].schema(), other.address);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.extraRecord.Builder setAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.extraRecord.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.extraRecord.Builder setOffice(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.extraRecord.Builder clearOffice() {
      office = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.extraRecord.Builder setRssUrl(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.extraRecord.Builder clearRssUrl() {
      rss_url = null;
