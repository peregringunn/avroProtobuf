...
public class CarriersRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.hitachivantara.avro.CarriersRecord.Builder newBuilder() {
    return new com.hitachivantara.avro.CarriersRecord.Builder();
  }
   ...
   * @return A new CarriersRecord RecordBuilder
   */
  public static com.hitachivantara.avro.CarriersRecord.Builder newBuilder(com.hitachivantara.avro.CarriersRecord.Builder other) {
    if (other == null) {
      return new com.hitachivantara.avro.CarriersRecord.Builder();
    } else {
      return new com.hitachivantara.avro.CarriersRecord.Builder(other);
    }
  }
   ...
   * @return A new CarriersRecord RecordBuilder
   */
  public static com.hitachivantara.avro.CarriersRecord.Builder newBuilder(com.hitachivantara.avro.CarriersRecord other) {
    if (other == null) {
      return new com.hitachivantara.avro.CarriersRecord.Builder();
    } else {
      return new com.hitachivantara.avro.CarriersRecord.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CarriersRecord>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.hitachivantara.avro.CarriersRecord.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.hitachivantara.avro.CarriersRecord other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.Names)) {
        this.Names = data().deepCopy(fields()[0].schema(), other.Names);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.CarriersRecord.Builder setNames(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.CarriersRecord.Builder clearNames() {
      Names = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.CarriersRecord.Builder setTotal(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.CarriersRecord.Builder clearTotal() {
