...
public class Movies extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.hitachivantara.avro.Movies.Builder newBuilder() {
    return new com.hitachivantara.avro.Movies.Builder();
  }
   ...
   * @return A new Movies RecordBuilder
   */
  public static com.hitachivantara.avro.Movies.Builder newBuilder(com.hitachivantara.avro.Movies.Builder other) {
    if (other == null) {
      return new com.hitachivantara.avro.Movies.Builder();
    } else {
      return new com.hitachivantara.avro.Movies.Builder(other);
    }
  }
   ...
   * @return A new Movies RecordBuilder
   */
  public static com.hitachivantara.avro.Movies.Builder newBuilder(com.hitachivantara.avro.Movies other) {
    if (other == null) {
      return new com.hitachivantara.avro.Movies.Builder();
    } else {
      return new com.hitachivantara.avro.Movies.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Movies>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.hitachivantara.avro.Movies.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.hitachivantara.avro.Movies other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.title)) {
        this.title = data().deepCopy(fields()[0].schema(), other.title);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.Movies.Builder setTitle(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.Movies.Builder clearTitle() {
      title = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.Movies.Builder setYear(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.Movies.Builder clearYear() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.Movies.Builder setCast(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.Movies.Builder clearCast() {
      cast = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.Movies.Builder setGenres(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.Movies.Builder clearGenres() {
      genres = null;
