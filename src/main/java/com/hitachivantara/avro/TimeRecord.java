...
public class TimeRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.hitachivantara.avro.TimeRecord.Builder newBuilder() {
    return new com.hitachivantara.avro.TimeRecord.Builder();
  }
   ...
   * @return A new TimeRecord RecordBuilder
   */
  public static com.hitachivantara.avro.TimeRecord.Builder newBuilder(com.hitachivantara.avro.TimeRecord.Builder other) {
    if (other == null) {
      return new com.hitachivantara.avro.TimeRecord.Builder();
    } else {
      return new com.hitachivantara.avro.TimeRecord.Builder(other);
    }
  }
   ...
   * @return A new TimeRecord RecordBuilder
   */
  public static com.hitachivantara.avro.TimeRecord.Builder newBuilder(com.hitachivantara.avro.TimeRecord other) {
    if (other == null) {
      return new com.hitachivantara.avro.TimeRecord.Builder();
    } else {
      return new com.hitachivantara.avro.TimeRecord.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TimeRecord>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.hitachivantara.avro.TimeRecord.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.hitachivantara.avro.TimeRecord other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.Label)) {
        this.Label = data().deepCopy(fields()[0].schema(), other.Label);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.TimeRecord.Builder setLabel(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.TimeRecord.Builder clearLabel() {
      Label = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.TimeRecord.Builder setMonth(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.TimeRecord.Builder clearMonth() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.TimeRecord.Builder setMonthName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.TimeRecord.Builder clearMonthName() {
      MonthName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.TimeRecord.Builder setYear(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.TimeRecord.Builder clearYear() {
