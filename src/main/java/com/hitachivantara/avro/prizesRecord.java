...
public class prizesRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private com.hitachivantara.avro.laureatesRecord laureates;
   ...
   */
  public prizesRecord(java.lang.Long year, java.lang.CharSequence category, com.hitachivantara.avro.laureatesRecord laureates) {
    this.year = year;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: laureates = (com.hitachivantara.avro.laureatesRecord)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.hitachivantara.avro.laureatesRecord getLaureates() {
    return laureates;
  }
   ...
   * @param value the value to set.
   */
  public void setLaureates(com.hitachivantara.avro.laureatesRecord value) {
   ...
   */
  public static com.hitachivantara.avro.prizesRecord.Builder newBuilder() {
    return new com.hitachivantara.avro.prizesRecord.Builder();
  }
   ...
   * @return A new prizesRecord RecordBuilder
   */
  public static com.hitachivantara.avro.prizesRecord.Builder newBuilder(com.hitachivantara.avro.prizesRecord.Builder other) {
    if (other == null) {
      return new com.hitachivantara.avro.prizesRecord.Builder();
    } else {
      return new com.hitachivantara.avro.prizesRecord.Builder(other);
    }
  }
   ...
   * @return A new prizesRecord RecordBuilder
   */
  public static com.hitachivantara.avro.prizesRecord.Builder newBuilder(com.hitachivantara.avro.prizesRecord other) {
    if (other == null) {
      return new com.hitachivantara.avro.prizesRecord.Builder();
    } else {
      return new com.hitachivantara.avro.prizesRecord.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<prizesRecord>
    ...
    private java.lang.CharSequence category;
    private com.hitachivantara.avro.laureatesRecord laureates;
    private com.hitachivantara.avro.laureatesRecord.Builder laureatesBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.hitachivantara.avro.prizesRecord.Builder other) {
      super(other);
      ...
      if (other.hasLaureatesBuilder()) {
        this.laureatesBuilder = com.hitachivantara.avro.laureatesRecord.newBuilder(other.getLaureatesBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.hitachivantara.avro.prizesRecord other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.year)) {
        this.year = data().deepCopy(fields()[0].schema(), other.year);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.prizesRecord.Builder setYear(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.prizesRecord.Builder clearYear() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.prizesRecord.Builder setCategory(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.prizesRecord.Builder clearCategory() {
      category = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.prizesRecord.Builder setLaureates(com.hitachivantara.avro.laureatesRecord value) {
     ...
     * @return This builder.
     */
    public com.hitachivantara.avro.laureatesRecord.Builder getLaureatesBuilder() {
      if (laureatesBuilder == null) {
        if (hasLaureates()) {
          setLaureatesBuilder(com.hitachivantara.avro.laureatesRecord.newBuilder(laureates));
        } else {
          setLaureatesBuilder(com.hitachivantara.avro.laureatesRecord.newBuilder());
        }
      }
    ...
    public com.hitachivantara.avro.prizesRecord.Builder setLaureatesBuilder(com.hitachivantara.avro.laureatesRecord.Builder value) {
      clearLaureates();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.prizesRecord.Builder clearLaureates() {
      laureates = null;
    ...
    public prizesRecord build() {
      try {
        ...
        if (laureatesBuilder != null) {
          ...
          record.laureates = fieldSetFlags()[2] ? this.laureates : (com.hitachivantara.avro.laureatesRecord) defaultValue(fields()[2]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.laureates == null) {
        this.laureates = new com.hitachivantara.avro.laureatesRecord();
      }
