...
public class representatives extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public com.hitachivantara.avro.metaRecord getMeta() {
    return meta;
  }
   ...
   */
  public void setMeta(com.hitachivantara.avro.metaRecord value) {
    this.meta = value;
  }
   ...
   */
  public static com.hitachivantara.avro.representatives.Builder newBuilder() {
    return new com.hitachivantara.avro.representatives.Builder();
  }
   ...
   * @return A new representatives RecordBuilder
   */
  public static com.hitachivantara.avro.representatives.Builder newBuilder(com.hitachivantara.avro.representatives.Builder other) {
    if (other == null) {
      return new com.hitachivantara.avro.representatives.Builder();
    } else {
      return new com.hitachivantara.avro.representatives.Builder(other);
    }
  }
   ...
   * @return A new representatives RecordBuilder
   */
  public static com.hitachivantara.avro.representatives.Builder newBuilder(com.hitachivantara.avro.representatives other) {
    if (other == null) {
      return new com.hitachivantara.avro.representatives.Builder();
    } else {
      return new com.hitachivantara.avro.representatives.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<representatives>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.hitachivantara.avro.representatives.Builder other) {
      super(other);
      ...
      if (other.hasMetaBuilder()) {
        this.metaBuilder = com.hitachivantara.avro.metaRecord.newBuilder(other.getMetaBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.hitachivantara.avro.representatives other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.meta)) {
        this.meta = data().deepCopy(fields()[0].schema(), other.meta);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.representatives.Builder setMeta(com.hitachivantara.avro.metaRecord value) {
     ...
     * @return This builder.
     */
    public com.hitachivantara.avro.metaRecord.Builder getMetaBuilder() {
      if (metaBuilder == null) {
        if (hasMeta()) {
          setMetaBuilder(com.hitachivantara.avro.metaRecord.newBuilder(meta));
        } else {
          setMetaBuilder(com.hitachivantara.avro.metaRecord.newBuilder());
        }
      }
      return metaBuilder;
    }
    ...
    public com.hitachivantara.avro.representatives.Builder setMetaBuilder(com.hitachivantara.avro.metaRecord.Builder value) {
      clearMeta();
      metaBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hitachivantara.avro.representatives.Builder clearMeta() {
      meta = null;
      metaBuilder = null;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (this.meta == null) {
        this.meta = new com.hitachivantara.avro.metaRecord();
      }
